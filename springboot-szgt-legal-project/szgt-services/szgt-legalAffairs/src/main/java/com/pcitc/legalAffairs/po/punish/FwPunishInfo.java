 ...
 * @author 
 */
@TableName("fw_punish_info")
public class FwPunishInfo extends BasePojo {
    @TableId
    private Long fId;
    ...
    public Date getfPunishDate() {
        return fPunishDate;
    }

    public void setfPunishDate(Date fPunishDate) {
        this.fPunishDate = fPunishDate;
    }
