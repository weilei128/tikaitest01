...
public class OrganizationInfoAllVo {
    /**
     * 法律机构信息主键
     */
    private Integer fId;
     ...
     * 法律机构职员信息列表
     */
    List<OrganizationStaffVo> staffVoList;
    /**
     * 法律工作获奖信息列表
     */
    List<OrganizationWrokRewardVo> wrokRewardVoList;
    ...
    public List<OrganizationStaffVo> getStaffVoList() {
        return staffVoList;
    }

    public void setStaffVoList(List<OrganizationStaffVo> staffVoList) {
        this.staffVoList = staffVoList;
    }

    public List<OrganizationWrokRewardVo> getWrokRewardVoList() {
        return wrokRewardVoList;
    }

    public void setWrokRewardVoList(List<OrganizationWrokRewardVo> wrokRewardVoList) {
        this.wrokRewardVoList = wrokRewardVoList;
    }
