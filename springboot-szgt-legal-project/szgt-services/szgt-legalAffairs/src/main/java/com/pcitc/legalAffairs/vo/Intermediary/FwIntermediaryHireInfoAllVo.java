...
public class FwIntermediaryHireInfoAllVo {
    /**
     * 中介机构聘用信息主键
     */
    private Long fId;
     ...
     * 法律机构基本信息
     */
    List<FwIntermediaryOrgBasicHasLegalTeamVo> orgBasicHasLegalTeamVoList ;

    /**
     * 法律机构基本信息
     */
    List<FwIntermediaryOrgBasicHasLegalTeamVo> elections;
    ...
    public List<FwIntermediaryOrgBasicHasLegalTeamVo> getOrgBasicHasLegalTeamVoList() {
        return orgBasicHasLegalTeamVoList;
    }

    public void setOrgBasicHasLegalTeamVoList(List<FwIntermediaryOrgBasicHasLegalTeamVo> orgBasicHasLegalTeamVoList) {
        this.orgBasicHasLegalTeamVoList = orgBasicHasLegalTeamVoList;
    }
    ...
    public List<FwIntermediaryOrgBasicHasLegalTeamVo> getElections() {
		return elections;
	}

	public void setElections(List<FwIntermediaryOrgBasicHasLegalTeamVo> elections) {
