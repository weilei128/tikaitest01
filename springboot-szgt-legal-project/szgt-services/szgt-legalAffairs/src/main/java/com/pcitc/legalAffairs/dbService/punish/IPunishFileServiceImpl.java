...
import com.pcitc.legalAffairs.mapper.punish.PunishFileMapper;
import com.pcitc.legalAffairs.po.punish.FwPunishFile;
import com.pctic.common.utils.UserUtils;

@Service
public class IPunishFileServiceImpl extends ServiceImpl<PunishFileMapper, FwPunishFile> implements IPunishFileService {
	@Override
	public boolean save(FwPunishFile entity) {
	...
	@Override
	public boolean saveBatch(Collection<FwPunishFile> entityList) {
		SysUserInfo userInfo = UserUtils.getUserInfo();
		if (entityList != null) {
	...
	@Override
	public boolean updateById(FwPunishFile entity) {
		SysUserInfo userInfo = UserUtils.getUserInfo();
