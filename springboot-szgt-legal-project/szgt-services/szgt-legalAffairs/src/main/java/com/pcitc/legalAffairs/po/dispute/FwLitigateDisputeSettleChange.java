 ...
 * 纠纷处理方式转换表
 */
@TableName(value = "fw_litigate_dispute_settle_change")
public class FwLitigateDisputeSettleChange implements Serializable {
    ...
    public Long getfOriSettleMethod() {
        return fOriSettleMethod;
    }

    public void setfOriSettleMethod(Long fOriSettleMethod) {
        this.fOriSettleMethod = fOriSettleMethod;
    }
