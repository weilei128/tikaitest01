...
public class FwIntermediaryOrgPageVo {
    /**
     * 主键
     */
    private Long fId;
     ...
     * 银行信息列表
     */
    List<FwIntermediaryBankInfoVo> bankInfoVoList;
    /**
     * 联系人信息
     */
    List<FwIntermediaryLinkmanInfoVo> linkmanInfoVoList;
    /**
     * 市场评价信息
     */
    List<FwIntermediaryMarketEvalVo> marketEvalVoList;
    /**
     * 中介机构资质信息
     */
    List<FwIntermediaryQualifiInfoVo> qualifiInfoVoList;
    ...
    public List<FwIntermediaryBankInfoVo> getBankInfoVoList() {
        return bankInfoVoList;
    }

    public void setBankInfoVoList(List<FwIntermediaryBankInfoVo> bankInfoVoList) {
        this.bankInfoVoList = bankInfoVoList;
    }

    public List<FwIntermediaryLinkmanInfoVo> getLinkmanInfoVoList() {
        return linkmanInfoVoList;
    }

    public void setLinkmanInfoVoList(List<FwIntermediaryLinkmanInfoVo> linkmanInfoVoList) {
        this.linkmanInfoVoList = linkmanInfoVoList;
    }

    public List<FwIntermediaryMarketEvalVo> getMarketEvalVoList() {
        return marketEvalVoList;
    }

    public void setMarketEvalVoList(List<FwIntermediaryMarketEvalVo> marketEvalVoList) {
        this.marketEvalVoList = marketEvalVoList;
    }

    public List<FwIntermediaryQualifiInfoVo> getQualifiInfoVoList() {
        return qualifiInfoVoList;
    }

    public void setQualifiInfoVoList(List<FwIntermediaryQualifiInfoVo> qualifiInfoVoList) {
        this.qualifiInfoVoList = qualifiInfoVoList;
    }
