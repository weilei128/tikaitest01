...
public class FwIntermediaryOrgBasicHasLegalTeamVo {
    /**
     * 主键
     */
    private Long fId;
     ...
     * 聘用法律团队信息
     */
    List<FwIntermediaryHireLegalTeamVo> legalTeamVoList;
    ...
    public List<FwIntermediaryHireLegalTeamVo> getLegalTeamVoList() {
        return legalTeamVoList;
    }

    public void setLegalTeamVoList(List<FwIntermediaryHireLegalTeamVo> legalTeamVoList) {
        this.legalTeamVoList = legalTeamVoList;
    }
