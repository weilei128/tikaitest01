 ...
 * 诉前争议对方信息
 */
@TableName(value = "fw_litigate_dispute_opposite")
public class FwLitigateDisputeOpposite implements Serializable {
    ...
    public String getfStatusDescription() {
        return fStatusDescription;
    }

    public void setfStatusDescription(String fStatusDescription) {
        this.fStatusDescription = fStatusDescription;
    }
