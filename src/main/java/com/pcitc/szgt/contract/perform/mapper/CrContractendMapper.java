 ...
 * @since 2020-03-04
 */
public interface CrContractendMapper extends BaseMapper<CrContractend> {
    /*
     * 合同终止备案查询
     * */
    List<HashMap> selectSealContractEnd(IPage<HashMap> page, @Param("ew") QueryWrapper<CrContractbasic> contractbasicQueryWrapper);
}
