 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_onemon_month")
@ApiModel(value = "滚动预测1+11-月份对象", description = "滚动预测1+11-月份表")
public class DcReportRollingBugdetOnemonMonth implements Serializable {
