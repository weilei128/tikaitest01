 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_threemon_month")
@ApiModel(value = "滚动预测3+9-月份对象", description = "滚动预测3+9-月份表")
public class DcReportRollingBugdetThreemonMonth implements Serializable {
