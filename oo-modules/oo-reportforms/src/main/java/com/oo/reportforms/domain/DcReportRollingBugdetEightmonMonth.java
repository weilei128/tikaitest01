 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_eightmon_month")
@ApiModel(value = "滚动预测8+4-月份对象", description = "滚动预测8+4-月份表")
public class DcReportRollingBugdetEightmonMonth implements Serializable {
