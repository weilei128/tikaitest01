 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_fivemon_month")
@ApiModel(value = "滚动预测5+7-月份对象", description = "滚动预测5+7-月份表")
public class DcReportRollingBugdetFivemonMonth implements Serializable {
