...
/**
 * 国际公司钻完井工作量及预算执行情况-调整井
 *
 * @author oo
 * @date 2023-10-23
 */
@Data
@TableName("dc_report_budget_exe_infill")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "国际公司钻完井工作量及预算执行情况-调整井对象", description = "国际公司钻完井工作量及预算执行情况-调整井表")
public class DcReportBudgetExeInfill extends BaseEntity {
