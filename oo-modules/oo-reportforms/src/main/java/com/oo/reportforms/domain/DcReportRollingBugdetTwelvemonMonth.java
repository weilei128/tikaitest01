 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_twelvemon_month")
@ApiModel(value = "滚动预测12+0-月份对象", description = "滚动预测12+0-月份表")
public class DcReportRollingBugdetTwelvemonMonth implements Serializable {
