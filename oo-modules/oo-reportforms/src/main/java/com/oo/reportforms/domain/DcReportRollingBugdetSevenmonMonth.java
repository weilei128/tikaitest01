 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_sevenmon_month")
@ApiModel(value = "滚动预测7+5-月份对象", description = "滚动预测7+5-月份表")
public class DcReportRollingBugdetSevenmonMonth implements Serializable {
