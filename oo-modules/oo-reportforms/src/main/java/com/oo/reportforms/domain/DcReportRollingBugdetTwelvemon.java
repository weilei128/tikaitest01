 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_twelvemon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测12+0对象", description = "滚动预测12+0表")
public class DcReportRollingBugdetTwelvemon extends LogicEntity {
