 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_threemon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测3+9对象", description = "滚动预测3+9表")
public class DcReportRollingBugdetThreemon extends LogicEntity {
