 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_ninemon_month")
@ApiModel(value = "滚动预测9+3-月份对象", description = "滚动预测9+3-月份表")
public class DcReportRollingBugdetNinemonMonth implements Serializable {
