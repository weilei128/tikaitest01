 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_twomon_month")
@ApiModel(value = "滚动预测2+10-月份对象", description = "滚动预测2+10-月份表")
public class DcReportRollingBugdetTwomonMonth implements Serializable {
