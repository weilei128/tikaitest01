 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_onemon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测1+11对象", description = "滚动预测1+11表")
public class DcReportRollingBugdetOnemon extends LogicEntity {
