 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_elevenmon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测11+1对象", description = "滚动预测11+1表")
public class DcReportRollingBugdetElevenmon extends LogicEntity {
