 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_eightmon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测8+4对象", description = "滚动预测8+4表")
public class DcReportRollingBugdetEightmon extends LogicEntity {
