 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_fivemon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测5+7对象", description = "滚动预测5+7表")
public class DcReportRollingBugdetFivemon extends LogicEntity {
