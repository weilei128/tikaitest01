 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_elevenmon_month")
@ApiModel(value = "滚动预测11+1-月份对象", description = "滚动预测11+1-月份表")
public class DcReportRollingBugdetElevenmonMonth implements Serializable {
