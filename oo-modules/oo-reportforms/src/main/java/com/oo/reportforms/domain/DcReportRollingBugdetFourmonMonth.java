 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_fourmon_month")
@ApiModel(value = "滚动预测4+8-月份对象", description = "滚动预测4+8-月份表")
public class DcReportRollingBugdetFourmonMonth implements Serializable {
