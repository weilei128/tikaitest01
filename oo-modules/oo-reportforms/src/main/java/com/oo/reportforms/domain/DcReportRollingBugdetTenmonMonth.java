 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_tenmon_month")
@ApiModel(value = "滚动预测10+2-月份对象", description = "滚动预测10+2-月份表")
public class DcReportRollingBugdetTenmonMonth implements Serializable {
