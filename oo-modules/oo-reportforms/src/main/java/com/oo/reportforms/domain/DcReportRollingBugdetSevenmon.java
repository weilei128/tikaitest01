 ...
 */
@Data
@TableName("dc_report_rolling_bugdet_sevenmon")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "滚动预测7+5对象", description = "滚动预测7+5表")
public class DcReportRollingBugdetSevenmon extends LogicEntity {
