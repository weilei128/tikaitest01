...
public class SysDeptController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable Long deptId) throws NoSuchFieldException, IllegalAccessException {
        deptService.checkDeptDataScope(deptId);
        SysDept dept = deptService.selectDeptById(deptId);
        return AjaxResult.success(SysTranslateWrapper.build().entityVO(deptId.toString(), "dept", dept));
    }
    ...
    public AjaxResult remove(@PathVariable Long[] deptId)
    {
       /* if (deptService.hasChildByDeptId(deptId))
        ...
        //deptService.checkDeptDataScope(deptId);
        return toAjax(deptService.deleteDeptByIds(deptId));
    }
}
