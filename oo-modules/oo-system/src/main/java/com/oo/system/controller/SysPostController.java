...
public class SysPostController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable Long postId) throws NoSuchFieldException, IllegalAccessException {
        SysPost post = postService.selectPostById(postId);
        return AjaxResult.success(SysTranslateWrapper.build().entityVO(postId.toString(), "post", post));
    }
